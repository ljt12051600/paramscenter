            ...
            <div>
                <system-table ref="dataShow">
                    ...
                    <div slot="search" style="margin-bottom: 20px;">
                        ...
                        <el-button @click="datachoose" type="primary">确定</el-button>
...
export default {
    ...
    methods: {
        ...
        //  向父组件传值
        datachoose(){
            this.chooseObj.compPropertyCode = this.attrEditObj.unitDataCode;
            this.chooseObj.compPropertyCode = this.attrEditObj.unitDataDesc;
            this.chooseObj.selectionMethod = "";
            this.chooseObj.valueType = "";
            this.chooseObj.valueLength = this.attrEditObj.length;
            // console.log(this.chooseObj);
            this.$emit('dataSub',this.chooseObj);
            // doExitEdit();
