    ...
    <system-table>
      <div slot="top">
        <el-form ref="form" :inline="true" label-width="80px">
          <el-form-item label="业务名称">
            <el-input v-model.trim="query.businessName"></el-input>
          </el-form-item>
      ...
      <div slot="body">
        <el-table border ref="table" align="center" :data="data.rows" style="width: 100%;">
          ...
          <el-table-column align="center" prop="lastUpdateTime" label="修订时间" />
        </el-table>
...
<script>
  ...
  import {queryEditionChg,queryButtons} from '@/api/verManager';
  export default {
    mixins: [MIXIN],
    data() {
      return {
        ...
        //     81: 'turquoise',//检出-已修改
        //     82: 'deeppink',//检出-已删除
        //     89: 'MediumTurquoise',//已检入
        //     90: 'CornflowerBlue',//提交审批
        //     91: 'Chocolate',//驳回
        //     92: 'violet',//撤销
        //     99: 'limegreen'//已审批
        // },
    ...
    methods: {
      ...
      async getList(num) {
        ...
        postObj.pageNum--;
        let info = await queryEditionChg(postObj);
        if (info.resCode === "0") {
          this.data = {
            total: info.total,
            rows: info.rows || []
