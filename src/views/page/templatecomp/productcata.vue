            ...
            <el-col :span="16">
                <el-card class="min-height">
                    <div slot="header" class="clearfix">
                        ...
                        <!-- <span> -->
                        <el-form-item label="目录名称" prop="tranName">
                            <el-input
                                v-model.trim="postObj.tranName"
                                style="width: 200px;"
                            />
                        </el-form-item> 
                        <!-- </span> -->
                    ...
                    <div >
                        <el-button type="primary">目录新增</el-button>
                        <el-button type="primary">目录修改</el-button>
                        <el-button type="primary">目录删除</el-button>
                        <el-button type="primary">目录层级</el-button>
                    </div>
