                ...
                <el-table border ref="table" align="center" :data="data.rows" style="width: 100%;">
                    ...
                    <el-table-column label="操作" width="400" align="center" fixed="right">
                        <template slot-scope="scope">
                            ...
                            >查看用户</el-button>
                            <el-button
                                @click="doShareRole(scope.row,scope.index)"
                                type="primary"
                            >分配菜单</el-button>
            ...
            <el-dialog title="分配菜单和按钮权限" :visible="showTree" width="800px" :show-close="false">
                <el-row :gutter="20">
                    ...
                    <el-col v-if="selectItem.menuType=='L'" :span="12">
                        ...
                        <el-card>
                            <div slot="header">按钮配置</div>
                            <el-checkbox-group v-model="aa">
                                <el-checkbox
                                    style="width:100px;height:30px"
                                    :label="item.buttonId"
                                    :key="item.buttonId"
                                    v-for="(item,index) in buttonAll"
...
export default {
    ...
    methods: {
        ...
        nodeClick(item) {
            ...
            if (item.menuId == this.selectItem.menuId) this.aa = [];
