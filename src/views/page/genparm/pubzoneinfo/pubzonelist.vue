    ...
    <div>
        ...
        <div slot="body">
            <el-table border ref="table" align="center" :data="data.rows"  height="380" 
                ...
                <el-table-column align="center" prop="brcCode" label="省份" />
                <el-table-column align="center" prop="brcCode" label="地区代码" />
                <el-table-column align="center" prop="brcName" label="地区名称" />
        ...
        <div v-if="showEdit"  >
            <pubzoneEdit @doClose="closeAddPage" :editObj='editObj' 
                :type='type' :showEdit="showEdit"></pubzoneEdit>   
        </div>
    </div>
...
import pubzoneEdit from './pubzoneedit.vue';
export default {
    mixins: [MIXIN],
    components: {pubzoneEdit},
    data() {
        return {
