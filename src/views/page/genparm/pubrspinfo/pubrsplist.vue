    ...
    <div>
        ...
        <div slot="body">
            <el-table border ref="table" align="center" :data="data.rows"  height="380" 
                ...
                <el-table-column align="center" prop="brcCode" label="响应码" />
                <el-table-column align="center" prop="brcName" label="标准响应码" />
                <el-table-column align="center" prop="brcName" label="响应码描述" />
        ...
        <div v-if="showEdit"  >
            <pubrspEdit @doClose="closeAddPage" :editObj='editObj' 
                :type='type' :showEdit="showEdit"></pubrspEdit>   
        </div>
    </div>
...
import pubrspEdit from './pubrspedit.vue';
export default {
    mixins: [MIXIN],
    components: {pubrspEdit},
    data() {
        return {
