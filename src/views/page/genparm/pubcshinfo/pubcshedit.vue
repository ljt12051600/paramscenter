            ...
            <el-form ref="showEdit" :model="editObj"  :rules="rules" size="small" label-width="160px">
                    ...
                    <el-form-item label="借贷标志" >
                        <el-select style="width:200px;" v-model="editObj.baseCcy" :disabled='flag' clearable placeholder="请选择"  >
                            <el-option :key="index+'cc'" v-for="(item,index) in loanSignList" :label="item.value+'-'+item.name" :value="item.value"
                            ></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="属性" >
                        <el-select style="width:200px;" v-model="editObj.baseCcy" :disabled='flag' clearable placeholder="请选择"  >
                            <el-option :key="index+'cc'" v-for="(item,index) in cshAttrList" :label="item.value+'-'+item.name" :value="item.value"
                            ></el-option>
                        </el-select>
                    </el-form-item>
