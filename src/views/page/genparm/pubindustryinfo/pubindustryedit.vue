    ...
    <div>
        ...
        <div>
            <el-form ref="showEdit" :model="editObj"  :rules="rules" size="small" label-width="160px">
                    ...
                    <el-form-item label="应用客户" prop="brcCode">
                        <el-input style="width:200px;" v-model.trim="editObj.brcCode" :disabled='flag'></el-input>
                    </el-form-item>
                    <el-form-item label="所属法人" prop="brcCode">
                        <el-input style="width:200px;" v-model.trim="editObj.brcCode" :disabled='flag'></el-input>
                    </el-form-item>
                    
                    <el-form-item label="行业代码" prop="brcName">
                        <el-input style="width:200px;" v-model.trim="editObj.brcName" :disabled='flag'></el-input>
                    </el-form-item>
                    <el-form-item label="行业描述" prop="brcCode">
                        <el-input style="width:200px;" v-model.trim="editObj.brcCode" :disabled='flag'></el-input>
                    </el-form-item>
                    <!-- <el-form-item label="生效日期" prop="brcName">
                        <el-input style="width:200px;" v-model.trim="editObj.brcName" :disabled='flag'></el-input>
                    </el-form-item>
                    <el-form-item label="失效日期" prop="brcName">
                        <el-input style="width:200px;" v-model.trim="editObj.brcName" :disabled='flag'></el-input>
                    </el-form-item> -->
