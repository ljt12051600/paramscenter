    ...
    <div>
        ...
        <div slot="body">
            <el-table border ref="table" align="center" :data="data.rows"  height="380" 
                ...
                <el-table-column align="center" prop="brcCode" label="系统编码" />
                <el-table-column align="center" prop="brcName" label="系统名称" />
        ...
        <div v-if="showEdit"  >
            <pubsysEdit @doClose="closeAddPage" :editObj='editObj' 
                :type='type' :showEdit="showEdit"></pubsysEdit>   
        </div>
    </div>
...
import pubsysEdit from './pubsysedit.vue';
export default {
    mixins: [MIXIN],
    components: {pubsysEdit},
    data() {
        return {
