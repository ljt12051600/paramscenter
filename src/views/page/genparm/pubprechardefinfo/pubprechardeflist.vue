    ...
    <div>
        ...
        <div slot="body">
            <el-table border ref="table" align="center" :data="data.rows"  height="380" 
                ...
                <el-table-column align="center" prop="brcCode" label="冠字代码" />
                <el-table-column align="center" prop="brcName" label="冠字号" />
                <el-table-column align="center" prop="brcName" label="冠字描述" />
        ...
        <div v-if="showEdit"  >
            <pubprechardefEdit @doClose="closeAddPage" :editObj='editObj' 
                :type='type' :showEdit="showEdit"></pubprechardefEdit>   
        </div>
    </div>
...
import pubprechardefEdit from './pubprechardefedit.vue';
export default {
    mixins: [MIXIN],
    components: {pubprechardefEdit},
    data() {
        return {
