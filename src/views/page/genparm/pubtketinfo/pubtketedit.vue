    ...
    <div>
        ...
        <div>
            <el-form ref="showEdit" :model="editObj" inline :rules="rules" size="small" label-width="160px">
                    ...
                    <el-form-item label="币种号" prop="baseCcy">
                        <el-input style="width:200px;" v-model.trim="editObj.baseCcy" :disabled='flag'></el-input>
                    </el-form-item>
                    <el-form-item label="券别" prop="brcName">
                        <el-input style="width:200px;" v-model.trim="editObj.brcName" :disabled='flag'></el-input>
                    </el-form-item>
                    <el-form-item label="现钞面值" prop="brcName">
                        <el-input style="width:200px;" v-model.trim="editObj.brcName" :disabled='flag'></el-input>
                    </el-form-item>
                    <el-form-item label="现钞单位" prop="brcName">
                        <el-input style="width:200px;" v-model.trim="editObj.brcName" :disabled='flag'></el-input>
                    </el-form-item>
                    
                    
                    <el-form-item label="最小面额标志" >
                    ...
                    <el-form-item label="标准单位标志" >
                        <el-select style="width:200px;" v-model="editObj.baseCcy" :disabled='flag' clearable placeholder="请选择"  >
                            <el-option :key="index+'cc'" v-for="(item,index) in isList" :label="item.value+'-'+item.name" :value="item.value"
                            ></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="找零标志" >
                        <el-select style="width:200px;" v-model="editObj.baseCcy" :disabled='flag' clearable placeholder="请选择"  >
                            <el-option :key="index+'cc'" v-for="(item,index) in isList" :label="item.value+'-'+item.name" :value="item.value"
                            ></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="辅币标志" >
                        <el-select style="width:200px;" v-model="editObj.baseCcy" :disabled='flag' clearable placeholder="请选择"  >
                            <el-option :key="index+'cc'" v-for="(item,index) in isList" :label="item.value+'-'+item.name" :value="item.value"
                            ></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="票面金额" prop="brcName">
                        <el-input style="width:200px;" v-model.trim="editObj.brcName" :disabled='flag'></el-input>
                    </el-form-item>
...
import {  ccyTypeList ,isList  } from '@/utils/parmstanddata';
