    ...
    <div>
        ...
        <div slot="body">
            <el-table border ref="table" align="center" :data="data.rows"  height="380" 
                ...
                <el-table-column align="center" prop="brcName" label="券别" />
                <el-table-column align="center" prop="brcName" label="现钞面值" />
                <el-table-column align="center" prop="brcName" label="现钞单位" />
                <el-table-column align="center" prop="baseCcy" label="最小面额标志">
                    <template slot-scope="scope">{{isObj[scope.row.compClassification]}}</template>
                </el-table-column>
                <el-table-column align="center" prop="baseCcy" label="标准单位标志">
                    <template slot-scope="scope">{{isObj[scope.row.compClassification]}}</template>
                </el-table-column>
                <el-table-column align="center" prop="baseCcy" label="找零标志">
                    <template slot-scope="scope">{{isObj[scope.row.compClassification]}}</template>
                </el-table-column>
                <el-table-column align="center" prop="baseCcy" label="辅币标志">
                    <template slot-scope="scope">{{isObj[scope.row.compClassification]}}</template>
                </el-table-column>
                
                <el-table-column align="center" prop="brcName" label="票面金额" />
        ...
        <div v-if="showEdit"  >
            <pubtketEdit @doClose="closeAddPage" :editObj='editObj' 
                :type='type' :showEdit="showEdit"></pubtketEdit>   
        </div>
    </div>
