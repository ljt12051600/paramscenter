    ...
    <div>
        ...
        <div slot="body">
            <el-table border ref="table" align="center" :data="data.rows"  height="380" 
                ...
                <el-table-column align="center" prop="brcCode" label="摘要码" />
                <el-table-column align="center" prop="brcName" label="描述" />
                <el-table-column align="center" prop="brcName" label="分类标识" />
        ...
        <div v-if="showEdit"  >
            <pubmemEdit @doClose="closeAddPage" :editObj='editObj' 
                :type='type' :showEdit="showEdit"></pubmemEdit>   
        </div>
    </div>
...
import pubmemEdit from './pubmemedit.vue';
export default {
    mixins: [MIXIN],
    components: {pubmemEdit},
    data() {
        return {
