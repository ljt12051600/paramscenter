<template>
    <div class="app-container">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        ...
                        <el-form ref="form" :inline="true" label-width="80px">
                            ...
                            <el-form-item label="数据标准">
                                <el-select
                                    ...
                                    placeholder="请选择"
                                >
                                    <el-option label="1-企业级" value="1"></el-option>
                                    <el-option label="2-应用级" value="2"></el-option>
                                </el-select>
                            </el-form-item>
                ...
                <el-table border ref="table" align="center" :data="data.rows" style="width: 100%;">
                    ...
                    <el-table-column align="center" prop="userSex" label="性别">
                        <template slot-scope="scope">{{sexDic[scope.row.userSex]}}</template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作" width="380" align="center" fixed="right">
                        <template slot-scope="scope">
                            ...
                            <el-button
                                @click="doShowRole(scope.row,scope.index)"
                                type="primary"
                            >分配角色</el-button>
        ...
        <div v-if="showRole">
            <el-dialog
                :title="'修改'+selectPeople.userName+'的角色'"
                :visible="showRole"
                width="800px"
                :show-close="false"
            >
